...
public class Point3 extends Tuple3
{
  ...
  /**
   * Copy constructor.  This constructor simplyd calls the explicit
  ...
  public Point3 subReturn(Point3 p)
  {
	  return new Point3(this.x-p.y, this.y-p.y, this.z-p.z);
  }
  ...
  public Point3 subPoint(Point3 p)
  {
