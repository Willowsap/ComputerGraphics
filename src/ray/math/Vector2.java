...
public class Vector2 extends Tuple2
{
  ...
  /**
   * Returns the dot product of this Vector2 object and the parameter
   * Vector2.
   * @param rhs The right hand operand.
   * @return The dot product of this Vector2 object and the parameter
   * Vector2.
   */
  ...
  /**
   * Returns the length squared of this vector.  Very useful if only comparison of lengths is
   * needed since it saves the square root.
  ...
  /**
   * This method will normalize this Vector2 so that its length is 1.0.
   * If the length of the Vector2 is 0, no action is taken.
   */
