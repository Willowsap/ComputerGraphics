...
public class Vector3 extends Tuple3 {
  ...
  /**
   * Returns the dot product of this Vector3 object and the parameter
   * Vector3.
   * @param rhs The right hand operand.
   * @return The dot product of this Vector3 object and the parameter
   * Vector3.
   */
   ...
   * If the length of the Vector3 is 0, no action is taken.
   */
  ...
  public Vector3 subReturn(Vector3 v)
  {
